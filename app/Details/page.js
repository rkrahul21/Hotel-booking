...
export default function DetailsPage() {
  ...
  return (
    <main className="w-ful mx-auto py-10 px-4 ">
      <div className="flex flex-col items-center mb-6">
        ...
        <h1 className="text-3xl font-bold mb-1" style={{ color: '#fb610b' }}>{hotel.name}</h1>
      ...
      <div className="mb-6">
        ...
        <ul className="space-y-2">
          {hotel.rooms && hotel.rooms.length > 0 ? hotel.rooms.map((room, idx) => (
      ...
      {showForm && selectedRoom && (
        <div className="w-full mt-10  ">
          <h3 className=" flex flex-col gap-2 items-center text-orange-900 justify-center text-3xl font-bold mb-2">Book: {selectedRoom.name}</h3>
